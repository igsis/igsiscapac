					...
					if(move_uploaded_file($nome_temporario, $dir.$new_name))
					{
						...
						if($query)
						{
							if(file_exists($dir.$newname))
							{
								...
								echo '<script>window.location = "?perfil=oficineiro_pf_arquivos_dados_bancarios"</script>';
							}
							else
							{
		...
		<div class="row">
			<div class="col-md-offset-1 col-md-10">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
						<div class="table-responsive list_info"><h6>Arquivo(s) Anexado(s)</h6>
							<?php listaArquivoCamposMultiplos($idPf,$tipoPessoa,$idCampo,"oficineiro_pf_arquivos_dados_bancarios",3); ?>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
						<div class = "center">
						<form method="POST" action="?perfil=oficineiro_pf_arquivos_dados_bancarios" enctype="multipart/form-data">
							<table>
								<tr>
									<td width="50%"><td>
								</tr>
