...
<!--                                style="text-align: left;"-->
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-2">
                        <form class="form-horizontal" role="form" action="<?= ($tipoPessoa == 4) ? "?perfil=oficineiro_pf_dados_bancarios" : "?perfil=oficineiro_pj_arquivos_dados_bancarios"?>" method="post">
