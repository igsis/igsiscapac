                    ...
                    if(move_uploaded_file($nome_temporario, $dir.$new_name))
                    {
                        ...
                        if($query)
                        {
                            if(file_exists($dir.$new_name))
                            {
                                ...
                                echo '<script>window.location = "?perfil=oficineiro_pf_arquivos"</script>';
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-10">
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="table-responsive list_info"><h6>Arquivo(s) Anexado(s) Somente em PDF</h6>
                            <?php
                            $lista = 11;
                            listaArquivoCamposMultiplos($idPf,$tipoPessoa,"","oficineiro_pf_arquivos",$lista); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                        <div class = "center">
                            <form method="POST" action="?perfil=oficineiro_pf_arquivos" enctype="multipart/form-data">
                                <table>
                                    <tr>
                                        <td width="50%"><td>
                                    </tr>
