...
if(isset($_POST['cadastrarEndereco']))
{
    ...
    if(mysqli_query($con,$sql_atualiza_oficineiro_pf_endereco))
    {
        ...
        gravarLog($sql_atualiza_oficineiro_pf_endereco);
    }
    else
    {
                ...
                if(in_array($ext, $allowedExts)) //Pergunta se a extensão do arquivo, está presente no array das extensões permitidas
                {
                    if(move_uploaded_file($nome_temporario, $dir.$new_name))
                    {
                        ...
                        if($query)
                        {
                            ...
                            echo '<script>window.location = "?perfil=oficineiro_pf_endereco"</script>';
                        }
                        else
                        {
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-10">
                <form name="form1" class="form-horizontal" role="form" action="?perfil=oficineiro_pf_endereco" method="post" onSubmit="return verificaCampos()">
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="table-responsive list_info"><h6>Arquivo(s) Anexado(s)</h6>
                            <?php listaArquivoCamposMultiplos($idPf,$tipoPessoa,$idCampo,"oficineiro_pf_endereco",3); ?>
                        </div>
                    </div>
                </div>
                <!-- Upload de arquivo -->
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                        <div class = "center">
                            <form method="POST" action="?perfil=oficineiro_pf_endereco" enctype="multipart/form-data">
                                <table>
                                    <tr>
                                        <td width="50%"><td>
                                    </tr>
