			...
			<div class="col-md-offset-1 col-md-10">
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
						<form class="form-horizontal" role="form" action="?perfil=evento_pf_novo" method="post">
			...
			<div class="col-md-offset-1 col-md-10">
				...
				<?php
					$sql = "SELECT * FROM evento
							WHERE publicado = 1 AND idTipoPessoa = '$tipoPessoa' AND idPessoa ='$idPessoaFisica'
							ORDER BY id DESC";
